static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_GEMINITE_CITY - 1] = {MAP_GROUP(GEMINITE_CITY), MAP_NUM(GEMINITE_CITY), 30, 18},
    [HEAL_LOCATION_TEMPORAL_TOWER - 1] = {MAP_GROUP(TEMPORAL_TOWER), MAP_NUM(TEMPORAL_TOWER), 10, 17},
    [HEAL_LOCATION_HAUNTED_ISLE - 1] = {MAP_GROUP(HAUNTED_ISLE), MAP_NUM(HAUNTED_ISLE), 20, 20},
    [HEAL_LOCATION_TRAINER_ISLE - 1] = {MAP_GROUP(TRAINER_ISLE), MAP_NUM(TRAINER_ISLE), 16, 16},
    [HEAL_LOCATION_PATHOF_VICTORY - 1] = {MAP_GROUP(PATHOF_VICTORY), MAP_NUM(PATHOF_VICTORY), 20, 36},
    [HEAL_LOCATION_WATERFALL_GEORGE - 1] = {MAP_GROUP(WATERFALL_GEORGE), MAP_NUM(WATERFALL_GEORGE), 49, 15},
    [HEAL_LOCATION_NEW_BARK_TOWN - 1] = {MAP_GROUP(NEW_BARK_TOWN), MAP_NUM(NEW_BARK_TOWN), 15, 12},
    [HEAL_LOCATION_CHERRY_GROVE_CITY - 1] = {MAP_GROUP(CHERRY_GROVE_CITY), MAP_NUM(CHERRY_GROVE_CITY), 20, 15},
    [HEAL_LOCATION_VIOLET_CITY - 1] = {MAP_GROUP(VIOLET_CITY), MAP_NUM(VIOLET_CITY), 20, 20},
    [HEAL_LOCATION_ECRUTEAK_CITY - 1] = {MAP_GROUP(ECRUTEAK_CITY), MAP_NUM(ECRUTEAK_CITY), 26, 20},
};
