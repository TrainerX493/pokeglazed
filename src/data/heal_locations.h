static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_CHOCCO_TOWN - 1] = {MAP_GROUP(CHOCCO_TOWN), MAP_NUM(CHOCCO_TOWN), 0, 0},
    [HEAL_LOCATION_CHOCCO_TOWN_POKEMON_CENTER - 1] = {MAP_GROUP(CHOCCO_TOWN_POKEMON_CENTER), MAP_NUM(CHOCCO_TOWN_POKEMON_CENTER), 0, 0},
    [HEAL_LOCATION_OCEANVIEW_CITY - 1] = {MAP_GROUP(OCEANVIEW_CITY), MAP_NUM(OCEANVIEW_CITY), 0, 0},
};
